...
echo "💬 Interview at: http://localhost:3000/interview"
echo ""
echo "⏳ Note: First run downloads Llama 3.2 3B (~2GB, 1-3 minutes)."
echo "   Check progress with: docker logs -f ollama-init"
